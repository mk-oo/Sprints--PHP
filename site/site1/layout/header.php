...
if (!function_exists('str_contains2')) {
...
// if (str_contains($_SERVER['REQUEST_URL'], '/posts.php')) $current_page = 'posts';
// if (str_contains($_SERVER['REQUEST_URL'], '/myposts')) $current_page = 'myposts';
